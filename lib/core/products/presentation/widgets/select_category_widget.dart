...
class _SelectCategoryWidgetState extends State<SelectCategoryWidget> {
  final List<String> parentCategoryNames = ['- Select category -'];
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<ProductsCubit>()
        ..fetchCategoryBasedOnType(
            widget.categoryType, widget.parentCatId, widget.parentCatName),
      child: BlocConsumer<ProductsCubit, ProductsState>(
        listener: (ctx, state) {
          if (state is ProductsStateError) {
            ctx.displaySnack(state.messages);
          }
          if (state is ProductsStateCategories) {
            parentCategories
              ..clear()
        ...
        builder: (ctx, state) {
          return Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  widget.categoryType == CategoryType.category
                      ? "Select category"
                      ...
                      Expanded(
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? value) {
                            ...
                            widget.onCategorySelected(_getSelectedCategory());
                          },
