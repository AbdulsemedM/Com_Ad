...
Product detailsFromJson(String str) => Product.fromJson(json.decode(str));

String detailsToJson(Product data) => json.encode(data.toJson());
...
class Product {
  ...
  set productImages(List<String>? images) {
