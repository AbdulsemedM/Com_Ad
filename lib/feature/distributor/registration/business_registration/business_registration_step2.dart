...
class BusinessRegistrationstep2 extends StatefulWidget {
  const BusinessRegistrationstep2({super.key});

  @override
  State<BusinessRegistrationstep2> createState() =>
      _BusinessRegistrationstep2State();
}
...
class _BusinessRegistrationstep2State extends State<BusinessRegistrationstep2> {
              ...
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      _imageShop == null
                          ? const SizedBox(child: Text('JPG/PNG images'))
                          : SizedBox(
                              height: sHeight * 0.15,
                      ...
                      const Text("Commercial Certificate image"),
                      _imageCom == null
                          ? const SizedBox(child: Text('JPG/PNG images'))
                          : SizedBox(
                              height: sHeight * 0.15,
                      ...
                      const Text("Business Registration image"),
                      _imageBus == null
                          ? const SizedBox(child: Text('JPG/PNG images'))
                          : SizedBox(
                              height: sHeight * 0.15,
