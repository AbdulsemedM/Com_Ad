...
class AgentRegistrationstep2 extends StatefulWidget {
  const AgentRegistrationstep2({super.key});

  @override
  State<AgentRegistrationstep2> createState() => _AgentRegistrationstep2State();
}
...
class _AgentRegistrationstep2State extends State<AgentRegistrationstep2> {
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'Enter the details and attach the required dics to complete this step',
                              style: TextStyle(
