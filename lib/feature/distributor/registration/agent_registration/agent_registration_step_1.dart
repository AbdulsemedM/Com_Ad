...
class AgentStep1 extends StatefulWidget {
  const AgentStep1({super.key});

  @override
  State<AgentStep1> createState() => _AgentStep1State();
}

class _AgentStep1State extends State<AgentStep1> {
  String? fullName;
  String? email;
  String? mobileNumber;
  File? _image;
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'Enter the personal details and attach Profile image of the Agent',
                              style: TextStyle(
