...
import 'package:commercepal_admin_flutter/feature/merchant/flash_sale/add_flashsale_dialog.dart';
...
class AddFlashSale extends StatefulWidget {
  const AddFlashSale({super.key});

  @override
  State<AddFlashSale> createState() => _AddFlashSaleState();
}

class _AddFlashSaleState extends State<AddFlashSale> {
  var loading = false;
  var loading1 = false;
